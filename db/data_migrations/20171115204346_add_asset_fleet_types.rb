class AddAssetFleetTypes < ActiveRecord::DataMigration
  def up
    AssetFleetType.create!({
           ...
           custom_groups: 'primary_fta_mode_type_id,direct_capital_responsibility,primary_fta_service_type_id,secondary_fta_mode_type_id,secondary_fta_service_type_id',
           class_name: 'Vehicle',
           active: true
