...
ActiveRecord::Schema.define(version: 20171201172759) do
  ...
  add_index "planning_partners_organizations", ["organization_id"], name: "index_planning_partners_organizations_on_organization_id", using: :btree
  add_index "planning_partners_organizations", ["planning_partner_id"], name: "index_planning_partners_organizations_on_planning_partner_id", using: :btree
