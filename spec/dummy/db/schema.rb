...
ActiveRecord::Schema.define(version: 20170103225100) do
  ...
  create_table "ntd_admin_and_maintenance_facilities", force: true do |t|
    t.integer  "ntd_form_id"
    t.string   "name",                        limit: 64
    ...
    t.string   "facility_type",               limit: 32
  ...
  create_table "ntd_forms", force: true do |t|
    t.string   "object_key",          limit: 12
    t.integer  "form_id"
    t.integer  "organization_id"
    t.integer  "fy_year"
  ...
  create_table "ntd_passenger_and_parking_facilities", force: true do |t|
    t.integer  "ntd_form_id"
    t.string   "name",                        limit: 64
    t.boolean  "part_of_larger_facility"
    t.string   "address",                     limit: 128
  ...
  create_table "ntd_revenue_vehicle_fleets", force: true do |t|
    t.integer  "ntd_form_id"
    ...
    t.string   "funding_source",               limit: 32
    t.string   "manufacture_code",             limit: 4
    t.string   "model_number",                 limit: 32
    t.integer  "renewal_year"
    t.string   "renewal_type",                 limit: 32
    t.integer  "renewal_cost"
    t.integer  "renewal_cost_year"
    t.integer  "replacement_cost"
    t.integer  "replacement_cost_year"
  ...
  create_table "ntd_service_vehicle_fleets", force: true do |t|
    t.integer  "ntd_form_id"
    t.string   "name",                        limit: 64
    t.integer  "size"
    t.string   "vehicle_type",                limit: 32
    t.integer  "manufacture_year"
    t.integer  "avg_expected_years"
    t.integer  "pcnt_capital_responsibility"
    t.integer  "estimated_cost"
    t.integer  "estimated_cost_year"
    t.string   "notes",                       limit: 254
